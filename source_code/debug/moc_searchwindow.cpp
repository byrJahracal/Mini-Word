...
QT_MOC_LITERAL(4, 45, 22) // "on_closeButton_clicked"

    },
    "SearchWindow\0sendData\0\0on_pushButton_clicked\0"
...
void SearchWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SearchWindow::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchWindow::sendData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchWindow::sendData(QString _t1)
{
